...
\name{Ioannis}{Kyriazis}
\position{Full Stack Software Engineer}

\mobile{+1 774 534 0190}
\email{ioannis@vrsco.chat}
\homepage{ioannis.ky} 
\github{github.com/IKyriazis}
% \linkedin{linkedin.com/in/ioannis-kyriazis-466517181}
% \gitlab{gitlab-id}
...
% \input{cv/languages.tex} %removing for now
